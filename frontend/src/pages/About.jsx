...
const About = () => {
  useEffect(() => {
    AOS.init({ duration: 900, once: true, easing: 'ease-in-out', offset: 80 });
  }, []);
      ...
      <section className="relative h-[500px] md:h-[550px] w-full">
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex items-center">
          <div className="max-w-xl text-white" data-aos="fade-up">
            ...
            <button className="bg-pink-600 hover:bg-pink-700 px-6 py-2 rounded transition">
              Learn More
            </button>

            <div className="text-lg mt-6 text-pink-200">
              <Link to="/" className="hover:underline">Home</Link> / <span className="text-white">About</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <main className="px-4 sm:px-10 py-16 max-w-6xl mx-auto text-gray-800">
            ...
            {[
              ...
              >
                ...
                <img
                  src={item.img}
                  alt={item.title}
                  className="md:w-1/2 w-full h-60 object-cover rounded shadow hover:scale-105 transition duration-300"
                  loading="lazy"
                />
              </div>
            ))}
        ...
        <section className="my-20" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              <div key={item.title} className="bg-gray-50 p-6 rounded-lg shadow hover:shadow-xl transition">
                <img src={item.img} alt={item.title} className="w-full h-48 object-cover rounded mb-4" loading="lazy" />
        ...
        <section className="my-20" data-aos="fade-up">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={member.name} className="bg-white p-4 rounded shadow hover:shadow-xl transition">
                <img src={member.img} alt={member.name} className="w-full h-60 object-cover rounded mb-3" loading="lazy" />
        ...
        <section className="my-20" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: 'Rebecca Johnson', text: 'I’ve been a loyal customer since day one. The quality is unmatched!', img: rebeccaImg },
              { name: 'David Martinez', text: 'Ethical, elegant, and always evolving—StyleAura is my go-to.', img: davidImg },
              { name: 'Jennifer Williams', text: 'Amazing service and timeless pieces. I always feel confident!', img: jenniferImg },
            ].map((review) => (
              <div key={review.name} className="bg-gray-100 p-6 rounded shadow text-center hover:shadow-lg transition">
                <img src={review.img} alt={review.name} className="w-16 h-16 object-cover rounded-full mx-auto mb-4" loading="lazy" />
